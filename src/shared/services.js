...
const SetPatientAppointmentJoin = async (input) => {     return new Promise(async (resolve) => {
        
        const { Id, PatientID, AppointmentID, Deleted } = input;
        
        let method = "POST";
        let url = `${serverApi}PatientAppointments`;
        let data = { AppointmentID, PatientID: PatientID };

        if (Id && !Deleted) {
            method = "PATCH";
            url = `${serverApi}PatientAppointments(${Id})`;
        } else if (Id && Deleted) {
            method = "DELETE";
            data = {};
            url = `${serverApi}PatientAppointments(${Id})`;
...
const GetPatientAppointmentJoin = async (idValue) => {     return new Promise(async (resolve) => {
        let url = `${serverApi}PatientAppointments?$filter=PatientID eq ${idValue}`;
...
export {
 GetEntityInfo,  GetAppointmentsCount, GetAppointmentsMulti, GetAppointmentSingle, SetAppointmentSingle, GetPatientsCount, GetPatientsMulti, GetPatientSingle, SetPatientSingle, SetPatientAppointmentJoin, GetPatientAppointmentJoin, GetDoctorsCount, GetDoctorsMulti, GetDoctorSingle, SetDoctorSingle, GetProductStatus, GetMetaData, GetProductOnBoardings
};
